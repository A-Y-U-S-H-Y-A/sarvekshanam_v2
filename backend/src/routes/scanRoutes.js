...
router.post('/bulk', authenticate, heavyLimiter, ctrl.bulkScan);
...
router.get('/export/group/:groupId', authenticate, heavyLimiter, ctrl.exportGroup);
router.get('/:id/export', authenticate, heavyLimiter, ctrl.exportScan);
